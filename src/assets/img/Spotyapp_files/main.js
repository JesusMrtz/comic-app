...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>artist works!</p>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"card-columns\">\n    <div class=\"card\" *ngFor=\"let cancion of nuevasCanciones\">\n        <img [src]=\"cancion.images[0].url\" class=\"card-img-top\" alt=\"...\">\n        <div class=\"card-body\">\n            <h5 class=\"card-title\">{{cancion.name}}</h5>\n            <p class=\"card-text\">\n                <span class=\"badge badge-primary\" *ngFor=\"let artista of cancion.artists\">{{artista.name}}</span>\n            </p>\n        </div>\n    </div>\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"row\">\n    <div class=\"col\">\n        <input class=\"form-control\" type=\"text\" placeholder=\"Buscar artista\" (keyup)=\"buscar(inputArtist.value)\" #inputArtist>\n    </div>\n</div>");
...
/* harmony import */ var _components_artist_artist_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/artist/artist.component */ "./src/app/components/artist/artist.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_artist_artist_component__WEBPACK_IMPORTED_MODULE_9__["ArtistComponent"],
...
ArtistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-artist',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./artist.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/artist/artist.component.html")).default
    })
], ArtistComponent);
...
let SearchComponent = class SearchComponent {
    ...
    buscar(artist) {
        this._spotify.getArtist(artist)
            .subscribe((data) => {
...
let SpotifyService = class SpotifyService {
    ...
    getNewReleases() {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            Authorization: 'Bearer BQBparH1_ciTlmvhdBP8gpcZ3Ai5oJw9yNYjtuDsUD9Hyw-PjSIP80YBnxqxQ4kj7f2Mixp9RBY2og5gwzY'
        });
    ...
    getArtist(artist) {
        ...
        return this._http.get(`https://api.spotify.com/v1/search?query=${artist}&type=artist&market=MX&offset=0&limit=15`, { headers });
    }
};
...
__webpack_require__(/*! /Users/jmartinez/Desktop/Escritorio/Codes 2/Framework/Angular/05-spotyApp/spotyapp/node_modules/webpack-dev-server/client/index.js?http://0.0.0.0:0/sockjs-node&sockPath=/sockjs-node */"./node_modules/webpack-dev-server/client/index.js?http://0.0.0.0:0/sockjs-node&sockPath=/sockjs-node");
module.exports = __webpack_require__(/*! /Users/jmartinez/Desktop/Escritorio/Codes 2/Framework/Angular/05-spotyApp/spotyapp/src/main.ts */"./src/main.ts");
